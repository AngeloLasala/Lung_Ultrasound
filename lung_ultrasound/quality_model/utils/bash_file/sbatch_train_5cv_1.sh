...
#SBATCH --error=train_5cv_1.err              # standard error file
#SBATCH --output=train_5cv_1.out             # standard output file
...
for fold in fold_1 fold_2 fold_3 fold_4 fold_5; do
    ...
    python -m lung_ultrasound.quality_model.tools.train --fold "$fold" --timestamp "$TIMESTAMP" --splitting "splitting_ext_liver.json" --log info --keep_log
